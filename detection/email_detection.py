...
def detect_email_errors(email):
    ...
    if should_detect('2101', error_config) and rule_condition:
        ...
        if should_detect('2103', error_config) and rule_condition:
        ...
        if should_detect('2104', error_config) and rule_condition:
        ...
        if should_detect('2106', error_config) and rule_condition:
            ...
            if should_detect('2107', error_config) and rule_condition:
